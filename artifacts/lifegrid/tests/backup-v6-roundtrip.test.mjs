...
const store={activeCalendarId:'one',calendars:[{id:'one',name:'Fictional',createdAt:'2026-01-01T00:00:00.000Z',displayTimeZone:'UTC',data:{events:[],tasks:[],personEvents:[],categories:[{id:'other',label:'Other',color:'#666'}],people:[],projects:[]}}]};
